...
abstract class Plan {
    ...
    // Adding a new insurance plan with different criteria
    ...
    // Determine if a customer is eligible for an insurance plan
    ...
    // Getter functions for the different fields of a plan
    String getName() {
        return name;
    }
